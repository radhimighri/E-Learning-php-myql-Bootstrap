...
?>
		...
		<div class="container theme-showcase" role="main">
			...
			<div class="alert alert-danger"><h4 ><font color="">Inscription echoue !!!</font></h4></div>
			<div class="alert alert-warning"><h4 ><font color=""><u>NB :</u> Verifier votre cordonnees saisies !!!</font></h4></div>
			</div> 
		</div>
		<?php
		include ("foot.php");
