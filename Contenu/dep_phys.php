		...
		<div class="container theme-showcase" role="main">
			...
			<div class="jumbotron" style="width: 73%; float: right;">
				<div class="row">
					<?php
include("config.php");
					$sqlaff = 'select * from  utilisateurs,departement where `utilisateurs`.`departement_id_departement`= `departement`.`id_departement` and `departement`.`nom_departement`="Physique"  and `utilisateurs`.`confirmer`="1"';
