...
<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 960px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 240px; top: 0px; width: 720px; height: 480px; overflow: hidden;">
            <div>
                <img u="image" src="img/travelC/01.jpg" />
                <img u="thumb" src="img/travelC/thumb-01.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/02.jpg" />
                <img u="thumb" src="img/travelC/thumb-02.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/03.jpg" />
                <img u="thumb" src="img/travelC/thumb-03.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/04.jpg" />
                <img u="thumb" src="img/travelC/thumb-04.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/05.jpg" />
                <img u="thumb" src="img/travelC/thumb-05.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/06.jpg" />
                <img u="thumb" src="img/travelC/thumb-06.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/07.jpg" />
                <img u="thumb" src="img/travelC/thumb-07.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/08.jpg" />
                <img u="thumb" src="img/travelC/thumb-08.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/09.jpg" />
                <img u="thumb" src="img/travelC/thumb-09.jpg" />
            </div>
           
            
            <div>
                <img u="image" src="img/travelC/11.jpg" />
                <img u="thumb" src="img/travelC/thumb-11.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/12.jpg" />
                <img u="thumb" src="img/travelC/thumb-12.jpg" />
            </div>
            <div>
                <img u="image" src="img/travelC/13.jpg" />
                <img u="thumb" src="img/travelC/thumb-13.jpg" />
            </div>
        </div>
