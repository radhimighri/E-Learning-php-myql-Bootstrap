...
<td style="font-weight:bold"><font  color="#FFFFFF">Liste des commentaires :</font></td>
                ...
                <?php }   ?>
                  ...
                  <tr >
                   ...
                   <?php echo $data['comm']; ?><br />
                   <?php if($data['cin']==$_SESSION['cin']){ ?>
                   <a href="commentaireetudiant.php?suppr=<?php echo $data['cin']; ?>" style="float:right;" type="submit"   class="btn btn-xs btn-danger">
                        <span class="glyphicon glyphicon-trash"></span>
                         Supprimer </a>
                ...
                <?php }   ?></td>
                   ...
                   <?php } } ?>
                    ...
                    <hr />
                    <form action="commentaireprof.php"  method="post">
