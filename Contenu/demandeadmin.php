	...
	<body role="document" style="margin-bottom: 90px;">
		...
		<div class="container theme-showcase" role="main">
			...
			<div class="jumbotron" style="width: 73%; float: right;">
				...
				<div class="row">
			<form method="post" action="demandeadmin.php">
<div class="input-xlarge">
		...
		<label class="col-lg-3 control-label">Sujet:</label>
            ...
            <hr/>
         <center>   <button type="submit" name="valide" class="btn btn-sm btn-success">  Envoyer <span class="glyphicon glyphicon-send"></span></button> </center>
