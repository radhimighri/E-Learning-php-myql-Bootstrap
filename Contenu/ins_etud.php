	...
	include ("baniere.php");
	       ?>
			...
			<h2 align="center">Inscription Etudiant</h2>
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="ins_etudd.php">
          ...
          $reqgrp = mysqli_query($base,$sqlgrp) or die(mysqli_error($base));
          
          ?>
           <label class="col-lg-3 control-label">Groupe</label>
           <div class="col-lg-5">
            <select name="grp" class="form-control">
            <?php   while ($datag = mysqli_fetch_array($reqgrp)) {  ?>
