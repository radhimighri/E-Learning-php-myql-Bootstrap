	...
	include ("baniere.php");
	       ?>
			...
			<h2 align="center">Changement de mot de passe</h2>
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="changer_pwdphp_supadmin.php">
            

                        <div class="form-group">
                            <label class="col-lg-3 control-label">Tappez nouveau mot de passe</label>
                            <div class="col-lg-5">
