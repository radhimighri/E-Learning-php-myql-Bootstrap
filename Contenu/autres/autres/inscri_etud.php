...
?>
	...
	include ("baniere.php");
	       ?>
			...
			<form id="registration-form" action="inscri_etud.php" method="post" class="form-horizontal">
       
          <h3><font color="#3366FF">Inscription Etudiant:</font></h3>
    ...
    <div class="form-control-group">
		  ...
		  <div class="form-actions">
			...
			if (isset($_POST['valider'])) {
				...
				$sql = 'INSERT INTO utilisateurs VALUES("","' . $cin . '","' . $nom . '","' . $prenom . '","' . $sexe . '","' . $date_n . '","' . $email . '","' . $password . '","' . $tel . '","etud","","' . $grp . '","0")';
