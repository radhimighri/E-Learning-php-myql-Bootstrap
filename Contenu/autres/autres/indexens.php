			...
			?>
				...
				<div class="row">
                  <div align="center">
                    ...
                    <div align="center"><img src="images/bienvenue.fr.gif" width="327" height="54">    
                      </br></br>
                      </div>
                    <table class="table">
<tr style="background:#999">
<td style="font-weight:bold"><font  color="#FF0000"><font></td>
<td style="font-weight:bold"><font  color="#FF0000">Date<font></td>
...
<td style="font-weight:bold"><font  color="#FF0000">Fichier<font></td>
                   ...
                   <tr <?php if($today==$data['date_p']){ ?>class="info" <?php }else { ?> class="active" <?php } ?>>
					...
					<td>
					<?php echo $data['sujet']; ?> <?php echo $data['date_p']; ?> <hr/>
                    <?php echo $data['texte']; ?>
                    </td>
					<td>
