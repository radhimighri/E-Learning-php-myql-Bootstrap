		...
		<div class="container theme-showcase" role="main">
			...
			<div class="jumbotron" style="width: 73%; float: right;">
				<div class="row">
					<?php
include("config.php");
					$sqlaff = 'select * from  demande, utilisateurs where utilisateurs.profil="etud" and  `demande`.`utilisateurs_id_utilisateurs`=`utilisateurs`.`id_utilisateurs` and `demande`.`vue`="0" order by date_d ASC';
...
<td style="font-weight:bold">Action</td>
					...
					<td><?php echo $data['nom']; ?>&nbsp;<?php echo $data['prenom']; ?></td>
           			<td> <a href="demandeetuadmin.php?conf=<?php echo $data['id_demande']; ?>"  type="submit"   class="btn btn-xs btn-info">
			...
			<center>	<a href="demandeetuadmin.php?archive=1"  type="submit"   class="btn btn-sm btn-info"> Archive des demandes
				...
				<div class="row">
					<?php
include("config.php");
					$sqlaff = 'select * from  demande, utilisateurs where utilisateurs.profil="etud" and  `demande`.`utilisateurs_id_utilisateurs`=`utilisateurs`.`id_utilisateurs` order by date_d DESC';
					$req = mysqli_query($base,$sqlaff) or die(mysqli_error($base));
					?>
<table class="table">
<tr style="background:#999 ">
